...
//        Quan ly 1
        ...
        Employee e1 = new Employee("Nguyen Van A","nguyenvana@gmail.com",a1,d1,"QL001","quanli",3,15000000,240);
//        Quan ly 2
        Address a2 = new Address("43","An Phu Dong 10","An Phu Dong","Quan 12","TP HCM");
        Date d2 = new Date(1,1,2000);
        Employee e2 = new Employee("Nguyen Van B","nguyenvanb@gmail.com",a2,d2,"QL002", "quanli",3,16000000,200);
//        Quan ly 3
...
//        Quan ly 4
        ...
        Employee e4 = new Employee("Nguyen Minh Huu","nguyenminhhuu@gmail.com",a4,d4,"QL004","quanli",3,18000000,150);
//        Nhan vien 1
        Address a5 = new Address("18B","Duong so 2","Phuong Thanh My Loi","Quan 2","TP HCM");
        Date d5 = new Date(12,8,2003);
        Employee e5 = new Employee("Pham Van Du","phanvandu@gmail.com",a5,d5,"NV001","nhanvien",2.5f,8000000,300);
//        Nhan vien 2
        Address a6 = new Address("24","D2","Phuong 5","Quan Binh Thanh","TP HCM");
        Date d6 = new Date(5,6,2000);
        Employee e6 = new Employee("Luong Minh B","luongminhb@gmail.com",a6,d6,"NV002","nhanvien",2f,7000000,200);
//        Nhan vien 3
        Address a7 = new Address("25","D3","Phuong 6","Quan Tan Binh","TP HCM");
        Date d7 = new Date(5,6,2000);
        Employee e7 = new Employee("Ngo Minh C","ngominhc@gmail.com",a7,d7,"NV003", "nhanvien",2f,7500000,200);
//        Nhan vien 4
        Address a8 = new Address("8","D8","Phuong 8","Quan Binh Tan","TP HCM");
        Date d8 = new Date(15,6,2000);
        Employee e8 = new Employee("Le Van B","levanb@gmail.com",a8,d8,"NV004", "nhanvien",2f,6500000,210);
//        Nhan vien 5
        Address a9 = new Address("84","D3","Phuong 9","Quan Tan Phu","TP HCM");
        Date d9 = new Date(25,6,2000);
        Employee e9 = new Employee("Huynh Minh C","huynhminhc@gmail.com",a9,d9,"NV005","nhanvien",2f,6000000,150);
//        Nhan vien 6
...
//        ASUS
//        Laptop1
        Laptop laptop1 = new Laptop("ASUS ProArt Studiobook Pro 16 OLED W7600Z3A L2048W","Intel Core i9-12900H 2.5GHz up to 5.0GHz 24MB","32GB (16x2) DDR5 4800MHz (2x SO-DIMM socket, up to 64GB SDRAM)","AS","GVN",79990000,48,"LP001","16 inch","4K (3840 x 2400) OLED 16:10","VP");
//        Laptop2
        Laptop laptop2 = new Laptop("ASUS ROG Strix SCAR 15 G533ZW LN134W","Intel Core i9-12900H 3.8GHz up to 5.0GHz 24MB","32GB (16GBx2) DDR5 4800MHz (2x SO-DIMM socket, up to 64GB SDRAM)","AS","GVN",71990000,48,"LP002","15.6 inch","WQHD (2560 x 1440) 16:9","GM");
//        ACER
//        Laptop3
        Laptop laptop3 = new Laptop("Acer Swift Edge SFA16 41 R9WB","AMD Ryzen™ 7 PRO 6850U (2.7 GHz upto 4.70 GHz)","32GB LPDDR5 6400MHz (Onboard)","AC","GVN",45990000,48,"LP003","16 inch","WQUXGA (3840x2400) OLED 16:10","VP");
//        Laptop4
        Laptop laptop4 = new Laptop("Acer Predator Triton 500 SE PT516 52S 91XH","Intel® Core™ i9-12900H 3.80 GHz up to 5.00 GHz","32GB DDR5 4800MHz Onboard","AC","GVN",105990000,48,"LP004","16 inch","WQXGA (2560 x 1600) SlimBezel 240Hz","GA");
//        Lenovo
//        Laptop5
        Laptop laptop5 = new Laptop("Lenovo IdeaPad 5 Pro 16ARH7 82SN003LVN","AMD Ryzen 5 6600HS Creator Edition (6C / 12T, 3.3 / 4.5GHz, 3MB L2 / 16MB L3)","16GB LPDDR5 6400MHz dual-channel onboard","LE","GVN",26490000,48,"LP005","16 inch", "2.5K WQXGA (2560x1600) IPS","VP");
//        Laptop6
        Laptop laptop6 = new Laptop("Lenovo Legion 7 16IAX7 82TD008FVN","Intel Core i7-12700H","32GB (2x16GB) DDR5 4800MHz (2x SO-DIMM socket, up to 32GB SDRAM)","LE","GVN",76990000,48,"LP006","16 inch", "WQXGA (2560x1600) IPS 500nits Anti-glare","GA");
//        Dell
//        Laptop7
        Laptop laptop7 = new Laptop("Dell XPS 15 9520 70295790","Intel Core i9-12900HK 3.8GHz up to 5.0GHz 18MB","16GB (2 x 8GB) DDR5 4800MHz","DE","GVN",75990000,48,"LP007","15.6 inch", "3.5K QHD+ (3456 x 2160)","VP");
//        Laptop8
        Laptop laptop8 = new Laptop("Dell Alienware M15 R6 70272633","Intel Core i7-11800H 2.3GHz up to 4.6GHz 24MB","32GB (16x2) DDR4 3200MHz (2x SO-DIMM socket, up to 64GB SDRAM)","DE","GVN",54990000,48,"LP008","15.6 inch", "QHD (2560 x 1440) 240Hz","GA");
//        HP
//        Laptop9
...
//        Laptop10
    ...
    public static void initPC() {
        ...
        // PC4
        PC pc4 = new PC("MSI GeForce RTX 3080 Ti GAMING X TRIO 12G", "MSI GeForce RTX 3080 Ti GAMING X TRIO 12G", "Corsair Vengeance RS RGB 32gb (2x16GB) bus 3600", "GVN", "GVN", 67000000, 60, "PC004", "MSI MAG X570S TOMAHAWK WIFI", "MSI MAG X570S TOMAHAWK WIFI", "SamSung 980 PRO 500GB M.2 PCIe gen 4 NVMe", "Tùy chọn nâng cấp", "Corsair H150i ELITE CAPELLIX", "MSI GeForce RTX 3080 Ti GAMING X TRIO 12G", "GA");
        // PC5
        PC pc5 = new PC("GVN PHANTOM Plus a3080Ti","AMD Ryzen 7 5800X3D","AMD Ryzen 7 5800X3D","GVN","GVN",67000000,60,"PC005","MSI MAG X570S TOMAHAWK WIFI","MSI MAG X570S TOMAHAWK WIFI","SamSung 980 PRO 500GB M.2 PCIe gen 4 NVMe","Tùy chọn nâng cấp","Corsair H150i ELITE CAPELLIX","MSI GeForce RTX 3080 Ti GAMING X TRIO 12G","GA");
        // PC6
